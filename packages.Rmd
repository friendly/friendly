...
cat(desc("HistData"))
```
**Documentation**: [rdrr.io/cran/HistData/](https://rdrr.io/cran/HistData/)
...
cat(desc("ggCheysson"))
```
**Documentation**: [friendly.github.io/ggCheysson](https://friendly.github.io/ggCheysson/)
...
```{r CASIdata-desc, results='asis'}
cat(desc("CASIdata"))
```
**Documentation**: [friendly.github.io/CASIdata](https://friendly.github.io/CASIdata/)
...
```{r colorize-desc, results='asis'}
cat(desc("colorize"))
```
**Documentation**: [friendly.github.io/colorize](https://friendly.github.io/colorize/)
